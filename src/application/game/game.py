...
from src.application.game.game_objects.platform import Platform
...
class Game(Scene):
    ...
    def update(self, delta_time: float) -> None:
        ...
        self.__player_handler.update(delta_time, self.__platform_group, self.__enemy_handler.bullet_group)
        ...
        pygame.sprite.groupcollide(self.__platform_group, self.__player_handler.bullet_group, False, True)
        pygame.sprite.groupcollide(self.__platform_group, self.__enemy_handler.bullet_group, False, True)
        # pause menu
